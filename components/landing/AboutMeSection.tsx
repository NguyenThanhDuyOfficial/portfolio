  ...
  return (
    <section className="min-h-screen w-full px-32 grid grid-cols-12 items-center">
      ...
      <div className="col-span-7 col-start-7 grid grid-cols-7 gap-y-8">
        <p>Me</p>
        <p className="col-span-5 col-start-3 text-sm">
          Hi, I'm a software programmer, and I enjoy creating things that help
          people. Seeing people let go of their problems, become wiser, happier,
          and more peaceful is what I hope to see every day.{" "}
        </p>
        <p>Projects</p>
        <p className="col-span-5 col-start-3 text-sm">
          I strive to ensure my products meet at least three criteria:
          user-friendliness, efficiency, and security. I always focus on the
          project's architecture, clean code, and maintainability. I want my
          products to benefit both users and the developers who will maintain
          them in the future.
        </p>
        <p>Skills</p>
        ...
        <div className="col-span-5 col-start-3 text-sm">
          ...
          <Link href="/">
            <FontAwesomeIcon icon={faLinkedin} size="2xl"></FontAwesomeIcon>
          </Link>
        </div>
      </div>
    </section>
